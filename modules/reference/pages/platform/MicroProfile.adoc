...
- <<7-1, MicroProfile 7.1>>
- <<7-0, MicroProfile 7.0>>
...
Platform short name: `microProfile-7.1`
 
.microProfile-7.1 platform and versionless features
[%header,cols=3*]
|===
|Feature name
|Feature version
...
Platform short name: `microProfile-7.0`
 
.microProfile-7.0 platform and versionless features
[%header,cols=3*]
|===
|Feature name
|Feature version
...
Platform short name: `microProfile-1.0`
 
.microProfile-1.0 platform and versionless features
[%header,cols=3*]
|===
|Feature name
|Feature version
