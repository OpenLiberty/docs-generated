...
Platform short name: `jakartaee-11.0`
 
.jakartaee-11.0 platform and versionless features
[%header,cols=3*]
|===
|Feature name
|Feature version
...
|feature:persistenceContainer-3.2[]
