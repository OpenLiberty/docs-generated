...
include::./mpRestClient-4.0/description.adoc[opts=optional]

// tag::enable[]
== Enabling this feature
To enable the MicroProfile Rest Client 4.0 feature, add the following element declaration into your `server.xml` file, inside the `featureManager` element:
...
include::./mpRestClient-4.0/examples.adoc[opts=optional]
...
[source,]
----
io.openliberty.mpRestClient-4.0; type="osgi.subsystem.feature"
----
// end::feature-require[]
// tag::spi[]
// end::spi[]
