...
|+A unique configuration ID.+
|===
[#+cacheManager/cachingProvider/commonLibrary/path+]*cacheManager > cachingProvider > commonLibrary > path*
...
|+A unique configuration ID.+
|===
[#+cacheManager/cachingProvider/jCacheLibrary/path+]*cacheManager > cachingProvider > jCacheLibrary > path*
