...
|+A unique configuration ID.+
|===
[#+cache/cacheManager/cachingProvider/commonLibrary/path+]*cache > cacheManager > cachingProvider > commonLibrary > path*
...
|+A unique configuration ID.+
|===
[#+cache/cacheManager/cachingProvider/jCacheLibrary/path+]*cache > cacheManager > cachingProvider > jCacheLibrary > path*
