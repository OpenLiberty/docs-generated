* xref:api/open-liberty-apis.adoc[Open Liberty APIs]
  ...
  ** Application Security 6.0 (Jakarta Security 4.0)
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.websphere.security.auth.callback.adoc[com.ibm.websphere.security.auth.callback]
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.websphere.security.web.adoc[com.ibm.websphere.security.web]
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.wsspi.security.auth.callback.adoc[com.ibm.wsspi.security.auth.callback]
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.wsspi.security.common.auth.module.adoc[com.ibm.wsspi.security.common.auth.module]
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.wsspi.security.tai.adoc[com.ibm.wsspi.security.tai]
    *** xref:javadoc/api/appSecurity-6.0.com.ibm.wsspi.security.token.adoc[com.ibm.wsspi.security.token]
  ...
  ** Jakarta EE 11.0 Application Client
    *** xref:javadoc/api/jakartaeeClient-11.0.com.ibm.websphere.ejbcontainer.adoc[com.ibm.websphere.ejbcontainer]
    *** xref:javadoc/api/jakartaeeClient-11.0.com.ibm.websphere.endpoint.adoc[com.ibm.websphere.endpoint]
  ...
  ** Jakarta WebSocket 2.2
    *** xref:javadoc/api/websocket-2.2.adoc[com.ibm.websphere.wsoc]
